---
name: Moor - Cursor Inspired Design System
colors:
  surface: "#fdf8f7"
  surface-dim: "#ddd9d7"
  ...
  primary: "#11100a"
  on-primary: "#ffffff"
  primary-container: "#26251e"
  on-primary-container: "#8f8c82"
  ...
  tertiary: "#120f13"
  on-tertiary: "#ffffff"
  tertiary-container: "#272428"
  on-tertiary-container: "#908a8f"
  error: "#ba1a1a"
  on-error: "#ffffff"
  ...
  surface-500: "#e1e0db"
  error-warm: "#cf2d56"
  success-muted: "#1f8a65"
  step-thinking: "#dfa88f"
  step-grep: "#9fc9a2"
  step-read: "#9fbbe0"
  step-edit: "#c0a8dd"
